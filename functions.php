<?php
/**
 * wudang-shiyu functions and definitions
 *
...
function wudang_shiyu_setup() {
	 ...
	 * If you're building a theme based on wudang-shiyu, use a find and replace
	 * to change 'wudang-shiyu' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'wudang-shiyu', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'wudang-shiyu' ),
	) );
